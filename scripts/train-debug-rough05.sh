...
CUDA_VISIBLE_DEVICES=0 python -OO $ROOT_DIR/train_with_segm_debug.py --model_name person_car_annot_height_offset4_th06_min_inst10_rough05 --height 320 --width 1024 --segm_dirname modified_segms_labels_person_car_annot_height_offset4_th06_min_inst10 --rough_metric_scale_weight 0.5
