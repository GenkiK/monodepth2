...
CKPT_TIMESTAMP="06-05-05:51"
LAST_EPOCH=0


# train w/o outlier segms
CUDA_VISIBLE_DEVICES=0 python -OO $ROOT_DIR/train_with_road_stable_height_debug.py --model_name almost_vadepth_only_road --height 320 --width 1024 --segm_dirname modified_segms_labels_person_car_road --fine_metric_scale_weight 0.01 --start_with_cam_height_loss --batch_size 2 --learning_rate 5e-5 --gamma 0.5 --resume --ckpt_timestamp $CKPT_TIMESTAMP --last_epoch_for_resume $LAST_EPOCH --local
