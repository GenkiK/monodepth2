...
CUDA_VISIBLE_DEVICES=0 python -OO $ROOT_DIR/train_with_road_debug.py --model_name fine_after_original --height 320 --width 1024 --segm_dirname modified_segms_labels_person_car_road --fine_metric_scale_weight 0.01 --annot_height --resume --ckpt_timestamp $CKPT_TIMESTAMP --batch_size 2 --local
