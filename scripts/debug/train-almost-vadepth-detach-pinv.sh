...
CUDA_VISIBLE_DEVICES=5 python -OO $ROOT_DIR/train_with_road_stable_height.py --model_name almost_vadepth_only_road_detach_pinv --height 320 --width 1024  --fine_metric_scale_weight 0.01 --start_with_cam_height_loss --batch_size 8 --learning_rate 5e-5 --gamma 0.5

# CUDA_VISIBLE_DEVICES=5 python -OO $ROOT_DIR/train_with_road_stable_height.py --model_name person_car_annot_height_almost_vadepth --height 320 --width 1024 --segm_dirname modified_segms_labels_person_car_road --fine_metric_scale_weight 0.01 --start_with_cam_height_loss --batch_size 8 --learning_rate 5e-5 --gamma 0.5
