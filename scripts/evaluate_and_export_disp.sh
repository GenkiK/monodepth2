...
CUDA_VISIBLE_DEVICES=$DEVICE python -OO $ROOT_DIR/evaluate_and_export_disp.py --model_name person_car_annot_height_fine01 --ckpt_timestamp "05-17-14:40" --height 320 --width 1024 --epoch_for_eval $EPOCH --disp_filename_to_eval "disps_eigen_split_$EPOCH.npy"
CUDA_VISIBLE_DEVICES=$DEVICE python -OO $ROOT_DIR/evaluate_and_export_disp.py --model_name person_car_annot_height_fine05 --ckpt_timestamp "05-17-14:40" --height 320 --width 1024 --epoch_for_eval $EPOCH --disp_filename_to_eval "disps_eigen_split_$EPOCH.npy"
CUDA_VISIBLE_DEVICES=$DEVICE python -OO $ROOT_DIR/evaluate_and_export_disp.py --model_name person_car_annot_height_fine1 --ckpt_timestamp "05-17-14:40" --height 320 --width 1024 --epoch_for_eval $EPOCH --disp_filename_to_eval "disps_eigen_split_$EPOCH.npy"
CUDA_VISIBLE_DEVICES=$DEVICE python -OO $ROOT_DIR/evaluate_and_export_disp.py --model_name person_car_annot_height_fine2 --ckpt_timestamp "05-17-14:40" --height 320 --width 1024 --epoch_for_eval $EPOCH --disp_filename_to_eval "disps_eigen_split_$EPOCH.npy"
