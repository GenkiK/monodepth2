...
DATA_DIR="/home/gkinoshita/humpback/workspace/monodepth2/kitti_data"

# Our standard mono model
python $ROOT_DIR/train_with_segm.py --model_name M_1024x320 --height 320 --width 1024 --data_path $DATA_DIR
