...
CUDA_VISIBLE_DEVICES=2 python -OO $ROOT_DIR/train_with_road_debug.py --model_name person_car_annot_height_fine01 --height 320 --width 1024 --segm_dirname modified_segms_labels_person_car_road --fine_metric_scale_weight 0.1 --annot_height
