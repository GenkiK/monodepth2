...
from utils import masks_to_pix_heights, readlines
...
class TrainerWithSegmDebug:
    ...
    def run_epoch(self):
        ...
        for batch_input_dict in tqdm(self.train_loader):
...
if __name__ == "__main__":
    ...
    trainer = TrainerWithSegmDebug(opts)
    trainer.train()
